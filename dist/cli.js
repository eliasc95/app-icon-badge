...
// node_modules/.pnpm/zod-validation-error@1.5.0_zod@3.23.8/node_modules/zod-validation-error/dist/esm/utils/joinPath.js
...
// node_modules/.pnpm/zod-validation-error@1.5.0_zod@3.23.8/node_modules/zod-validation-error/dist/esm/utils/NonEmptyArray.js
function isNonEmptyArray(value) {
  return value.length !== 0;
}

// node_modules/.pnpm/zod-validation-error@1.5.0_zod@3.23.8/node_modules/zod-validation-error/dist/esm/ValidationError.js
...
function loadOverlay(_0) {
  return __async(this, arguments, function* ({ path: path5, background }) {
    const bannerOverlay = yield import_jimp.Jimp.read(path5);
...
program.addCommand(
  new import_commander.Command("add-badge").description(
    "add badge to the icon runs by default you don't need to specify this command "
  ).argument("<iconPath>", "required argument, icon path").addOption(
    new import_commander.Option("-t, --type <type>", "required option").choices(["banner", "ribbon"]).makeOptionMandatory()
  ).addOption(
  ...
  ).helpOption(false).action((iconPath, opts) => {
